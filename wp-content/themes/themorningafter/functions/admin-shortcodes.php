...
function woo_shortcode_tabs ( $atts, $content = null ) {
		...
		return '<div id="tabs-' . rand(1, 100) . '" class="shortcode-tabs ' . $style . '">' . $titles_html . do_shortcode( $content ) . '</div><!--/.tabs-->';
...
/*-----------------------------------------------------------------------------------*/
/* 23. Social Icon - [social_icon url="" float="" icon_url="" title=""]
/*-----------------------------------------------------------------------------------*/

function woo_shortcode_socialicon ( $atts, $content = null ) {

	$defaults = array( 'url' => '', 'float' => 'none', 'icon_url' => '', 'title' => '', 'profile_type' => '' );
	...
	return '<a href="' . trailingslashit( $url ) . '" title="' . $_alt_text . '"><img src="' . $_img_url . '" alt="' . $_alt_text . '" class="' . $_classes . '" /></a>' . "\n";
