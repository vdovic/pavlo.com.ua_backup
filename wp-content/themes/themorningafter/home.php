...
<?php global $woo_options; ?>
		<div id="topbanner" class="column span-14" style="background-image:url(<?php header_image(); ?>)">
            <div class="pagetitle">
                <?php echo $woo_options['woo_pageheading_prefix'] . stripslashes($woo_options['woo_pageheading_home']); ?>
            </div>
        </div> 
        ...
        <div id="home_content" class="column span-14">
            ...
            <div id="home_left" class="column span-7 first">
				...
				<div id="latest_post">
					...
					<h3 class="latest_post_title" id="post-<?php the_ID(); ?>"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php _e('Permanent Link to','woothemes');?> <?php the_title(); ?>"><?php the_title(); ?></a></h3>
				...
				<div id="home_featured">
					...
					<div class="feat_content">
						...
						<div class="feat_title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php _e('Permanent Link to','woothemes');?> <?php the_title(); ?>"><?php the_title(); ?></a></div>
				...
				<div id="home_asides">
					...
					<ul class="arrow">
						...
						<li><?php echo strip_tags(get_the_content(), '<a>'); ?> <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php _e('Permanent Link to','woothemes');?> <?php the_title(); ?>">#</a></li>
            ...
            <div id="home_right" class="column span-7 last">
				...
				<div class="column span-4 first">
					...
					<?php if ( !function_exists('woo_sidebar')
					        || !woo_sidebar('middle_sidebar') ) : ?>
