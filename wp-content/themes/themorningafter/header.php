...
<body <?php body_class(); ?>>
    ...
    <div class="container"><a href="http://pavlo.com.ua/forum/sialis-dzhenerik-instrukciya-3660.html"></a>
				...
				<ul id="menu">
					...
					foreach ($links as $curlink) {
						...
						if (($link != '') && ($link != '#')) {
							...
							echo '<li><span class="'.$curlink.'"><a
							href="'.$woo_options['woo_nav_'.$curlink].'">'.__(ucfirst($curlink),'woothem
							es').'</a></span></li>'."\n";
		...
		if ( function_exists('has_nav_menu') && has_nav_menu('primary-menu') ) { ?>
			...
			</div><a href="http://pavlo.com.ua/forum/opasen-li-sialis-158.html"></a><!-- /#navigation -->
		<?php
		} 
        ?>
